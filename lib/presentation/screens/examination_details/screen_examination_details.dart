...
import 'package:tooth_note/presentation/screens/examination_details/screen_add_examnation_details.dart';
...
class ExaminationDetailsScreen extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      floatingActionButton: InkWell(
        onTap: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const AddExaminationDetailsScreen(),
              ));
        },
        child: Container(
      ...
      body: BlocBuilder<PatientBloc, PatientState>(
        builder: (context, patientstate) {
          ...
          if (patient == null ||
              patient.examinationDetails == null ||
              patient.examinationDetails!.examinationDetails.isEmpty) {
            return Center(
              child: Image.asset(
          ...
          return ListView.builder(
            itemBuilder: (context, index) {
              if (index ==
                  patient!.examinationDetails!.examinationDetails.length) {
                return SizedBox(
            ...
            itemCount:
                patient.examinationDetails!.examinationDetails.length + 1,
          );
        },
      ),
    );
...
class EachContainerBox extends ConsumerWidget {
  ...
  Widget build(BuildContext context,WidgetRef ref) {
    DateTime? date;
    if (patient!.examinationDetails!.examinationDetails[index]['date']
        is Timestamp) {
      date = patient!.examinationDetails!.examinationDetails[index]['date']
          .toDate();
    }
    return InkWell(
      onLongPress: () {
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => ViewScreen(
                  data: patient!.examinationDetails!.examinationDetails[index]
                      ['value'],
                  onTap: () {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => AddExaminationDetailsScreen(
                            isToEdit: true,
                            index: index,
                            text: patient!.examinationDetails!
                                .examinationDetails[index]['value'],
                          ),
                        ));
                  }),
            ));
        ...
        child: Row(
          ...
          children: [
            SizedBox(
              width: size.width * 0.5,
              child: Text(
                patient!.examinationDetails!.examinationDetails[index]['value'],
                style: GoogleFonts.poppins(
                  textStyle: TextStyle(
                    letterSpacing: .5,
      ...
      if (value == 1) {
        alertBox(context, 'Delete', () {
          ...
          if (examinationDetailsDTO != null) {
            examinationDetailsList = examinationDetailsDTO.examinationDetails;
          }
          examinationDetailsList.removeAt(index);
          ...
          BlocProvider.of<PatientBloc>(context).add(PatientEvent.addPatient(
            ...
            address: patient.address,labInvestigation: patient.labInvestigation,doctor: patient.doctor,
